...
export const HeartboundAdventures: React.FC = () => {
  ...
  // Flower collect: +5 XP per flower
  const handleCollect = useCallback((total: number) => {
    setFlowerCount(total);
    setBondXP(prev => Math.min(100, prev + 5));
  }, []);

  // NPC interaction: direct XP grant from canvas
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4">
        ...
        <p className="text-white/30 text-xs mt-3">
          Collect 🌸 flowers &amp; talk to NPCs to earn Bond XP &nbsp;|&nbsp; ⚙️ to customise controls
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 pb-6">
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-md">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[{e:'🦌',n:'Sunny the Deer',x:'+8 Bond XP'},{e:'🧚',n:'Luna the Fairy',x:'+10 Bond XP'},{e:'🐇',n:'Pebble the Bunny',x:'+5 Bond XP'},{e:'🦉',n:'Sage the Owl',x:'+6 Bond XP'}].map(r=>(
          ...
          <p className="text-xs text-gray-400 mt-3 text-center">Walk close to any resident and press <kbd className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-xs">E</kbd> to talk and earn Bond XP</p>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-10 text-white">
          <div>
            ...
            <div className="space-y-3">
              {[{g:'🌃 Sky: Children of the Light',d:'Emotional co-op connection and discovery'},{g:'🏔️ Minecraft',d:'Shared world exploration and building'},{g:'🏡 Animal Crossing',d:'Cozy customization and life sim vibes'}].map(x=>(
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                {phase:'1',title:'Meadow Haven + NPCs (Live!)', desc:'Canvas world, co-op, controls, 4 residents with dialogue',done:true},
                {phase:'2',title:'Home Builder',                desc:'Shared interior, drag-drop furniture, Firebase-persisted layout',done:false},
