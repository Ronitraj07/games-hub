...
import {
  ...
  ArrowLeft, Star, ChevronRight, Play, Wifi, WifiOff,
} from 'lucide-react';
...
export const HeartboundAdventures: React.FC = () => {
  ...
  // Live presence from Firebase — shows who’s online right now
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4">
        ...
        <p className="text-white/30 text-xs mt-3">
          Collect 🌸 flowers to earn Bond XP • Press ⚙️ to customise controls
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50 dark:from-pink-950 dark:via-rose-950 dark:to-purple-950">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 text-center">
        ...
        {/* Enter button — no room code, just click and go */}
      ...
      <div className="bg-gradient-to-r from-pink-500 to-purple-600 py-12">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-10 text-white">
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                {phase:'1',title:'Meadow Haven (Live!)',    desc:'Canvas world, seamless co-op join, controls remapping',done:true},
                {phase:'2',title:'NPCs & Interactions',     desc:'Friendly deer, fairies, proximity prompts, dialogue',done:false},
